---
url: "https://open.feishu.cn/document/docs/bitable-v1/faq?lang=zh-CN"
title: "多维表格常见问题 - 服务端 API - 开发文档 - 飞书开放平台"
---
...
[1\. 如何在多维表格中上传附件？](https://open.feishu.cn/document/docs/bitable-v1/faq?lang=zh-CN#0ca9faef "1. 如何在多维表格中上传附件？")

[2\. 如何下载多维表格中的附件？](https://open.feishu.cn/document/docs/bitable-v1/faq?lang=zh-CN#b073756c "2. 如何下载多维表格中的附件？")

[3\. 调用多维表格相关接口，返回 1254040、1254041、1254042、1254043、1254044 等 NotFound 错误码，该如何解决？](https://open.feishu.cn/document/docs/bitable-v1/faq?lang=zh-CN#35c6fcf6 "3. 调用多维表格相关接口，返回 1254040、1254041、1254042、1254043、1254044 等 NotFound 错误码，该如何解决？")

[4\. 调用查询记录接口成功，数据返回为空，但实际多维表格存在数据，该如何解决？](https://open.feishu.cn/document/docs/bitable-v1/faq?lang=zh-CN#5095d8d7 "4. 调用查询记录接口成功，数据返回为空，但实际多维表格存在数据，该如何解决？")

[5\. 调用查询记录接口，复选框返回数据为空，如何解决？](https://open.feishu.cn/document/docs/bitable-v1/faq?lang=zh-CN#40093483 "5. 调用查询记录接口，复选框返回数据为空，如何解决？")

[6\. 如何筛选自定义编号类型的自动编号字段？](https://open.feishu.cn/document/docs/bitable-v1/faq?lang=zh-CN#5da525de "6. 如何筛选自定义编号类型的自动编号字段？")

[7\. 调用查询记录接口，如何筛选人员字段？](https://open.feishu.cn/document/docs/bitable-v1/faq?lang=zh-CN#b91b2c7 "7. 调用查询记录接口，如何筛选人员字段？")

[8\. 查询记录接口是否支持查询特定行，如数据表第 10 行~20 行的数据？](https://open.feishu.cn/document/docs/bitable-v1/faq?lang=zh-CN#6304cddc "8. 查询记录接口是否支持查询特定行，如数据表第 10 行~20 行的数据？")

[9\. 如何获取多维表格指定数据表的总记录数（或总行数）？](https://open.feishu.cn/document/docs/bitable-v1/faq?lang=zh-CN#c6f3a26c "9. 如何获取多维表格指定数据表的总记录数（或总行数）？")
...
[智能解释](https://open.feishu.cn/app/ai/playground?query=%E5%9F%BA%E4%BA%8E%E8%BF%99%E7%AF%87%E6%96%87%E6%A1%A3%20https%3A%2F%2Fopen.feishu.cn%2Fdocument%2Fdocs%2Fbitable-v1%2Ffaq%EF%BC%8C%E8%A7%A3%E9%87%8A%E4%B8%80%E4%B8%8B%20%E2%80%9C%E2%80%9D%20%E6%98%AF%E4%BB%80%E4%B9%88%E6%84%8F%E6%80%9D&from=doc_text_select) 文档纠错
...
[上一篇：多维表格概述](https://open.feishu.cn/document/server-docs/docs/bitable-v1/bitable-overview) [下一篇：数据结构概述](https://open.feishu.cn/document/server-docs/docs/bitable-v1/bitable-structure)
